...
#define APP_DIR_DEV                             "/var/log/e8_borealis/MQTT_Sub"
#define LOG_DIR_ALL_DEV                         "/var/log/e8_borealis/MQTT_Sub/all"
#define LOG_DIR_MESSAGES_READ_DEV               "/var/log/e8_borealis/MQTT_Sub/messagesread"
#define LOG_DIR_MESSAGES_WRITE_DEV              "/var/log/e8_borealis/MQTT_Sub/messageswrite"
#define LOG_DIR_ERROR_DEV                       "/var/log/e8_borealis/MQTT_Sub/errors"
#define LOG_DIR_QUERY_DEV                       "/var/log/e8_borealis/MQTT_Sub/queries"
#define LOG_DIR_DEBUG_DEV                       "/var/log/e8_borealis/MQTT_Sub/debug"

#define LOG_DIR_QFREE                           "/userdata/log/e8_borealis"
#define APP_DIR_QFREE                           "/userdata/log/e8_borealis/MQTT_Sub"
#define LOG_DIR_ALL_QFREE                       "/userdata/log/e8_borealis/MQTT_Sub/all"
#define LOG_DIR_MESSAGES_READ_QFREE             "/userdata/log/e8_borealis/MQTT_Sub/messagesread"
#define LOG_DIR_MESSAGES_WRITE_QFREE            "/userdata/log/e8_borealis/MQTT_Sub/messageswrite"
#define LOG_DIR_ERROR_QFREE                     "/userdata/log/e8_borealis/MQTT_Sub/errors"
#define LOG_DIR_QUERY_QFREE                     "/userdata/log/e8_borealis/MQTT_Sub/queries"
#define LOG_DIR_DEBUG_QFREE                     "/userdata/log/e8_borealis/MQTT_Sub/debug"

#define QFREE_CONFIG_LOCATION                   "/userdata/var/config/MQTT/config.cfg"

#define LOG_CATEGORY_ALL                        "aventi.e8borealis.mqttsub"
#define LOG_CATEGORY_MESSAGES_READ              "aventi.e8borealis.mqttsub.messages.read"
#define LOG_CATEGORY_MESSAGES_WRITE             "aventi.e8borealis.mqttsub.messages.write"
#define LOG_CATEGORY_ERROR                      "aventi.e8borealis.mqttsub.error"
#define LOG_CATEGORY_QUERIES                    "aventi.e8borealis.mqttsub.query"
#define LOG_CATEGORY_DEBUG                      "aventi.e8borealis.mqttsub.debug"

#define MQTT_CLIENT_ID                          "mqtt.subscriber.client_id"
#define MQTT_TOPIC                              "mqtt.publisher.topic"
#define MQTT_QOS                                "mqtt.subscriber.qos"
